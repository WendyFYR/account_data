...
### Project contents
The ports are set to the defaults of 2222 for http and 8443 for https and are exposed to the CLI in the cli-config.yml file.
...
1. `mvn install`
1. `java -jar ./target/account-data-1.0-SNAPSHOT.jar`
